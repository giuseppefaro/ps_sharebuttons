		...
		<div class="social-wrap">
              ...
              <!-- Instagram Button -->
                    <div class="itemSocialButton itemTumblrButton">
                        <a href="https://www.instagram.com/sharer.php?u={$smarty.server.HTTP_HOST|escape:'htmlall':'UTF-8'}{$smarty.server.REQUEST_URI|escape:'htmlall':'UTF-8'}" class="fb-share" data-count="horizontal" ><img src="instagram.png" alt="Instagram">
